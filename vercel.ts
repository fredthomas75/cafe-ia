...
//
// Région choisie pour la proximité Montréal :
//   - iad1 (Washington, ~750 km) → latence ~25 ms depuis Montréal
// Failover region : Enterprise plan seulement, on s'en passe en Hobby/Pro.
...
export const config: VercelConfig = {
  ...
  functions: {
    "app/api/checkout/route.ts": {
      ...
      // `memory` n'a plus d'effet avec Active CPU billing (Fluid 2026) —
      // on garde juste maxDuration.
      maxDuration: 30,
    },
  },
  headers: [
